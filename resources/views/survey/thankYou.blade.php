        ...
        <div class="header-body text-center mt-7 mb-7">
            <div class="row justify-content-center">
                <div class="col-lg-5 col-md-6">
                    ...
                    <h1 class="display-2 text-silentGreen">{{ __('Thank´s!!!') }}</br>{{ auth()->user()->name }}{{ __(', for participating.') }}</h1>
                    <p class="lead text-white">{{ __('see you tomorrow') }}</p>
                    ...
                    <div class="text-center">
                       ...
                       document.getElementById('logout-form').submit();"><button class="btn btn-lg btn-outline-neutral mt-4">{{ __('Log Out') }}</button></a>
                    </div>
                </div>
            </div>
        </div>
